...
@private
    ...
    NSString* showDirectory;
    NSString* showName;
}

+ (FSNodeInfo *)nodeWithParent:(FSNodeInfo*)parent atRelativePath:(NSString *)path mediaDirectory:(NSString*)dir;

- (id)initWithParent:(FSNodeInfo*)parent atRelativePath:(NSString*)path mediaDirectory:(NSString*)dir;
